...
// Puis dans mon FOR (car je veux qu'il agisse sur les éléments un à un) j'ajoute l'évéenement sur mon élément voulu (ici les h3). J'indique donc que je veux que mes p soient en display "block" au moment du click sur mes h3.

    h3FAQ[i].addEventListener("click", function () {
        pFAQ[i].style.display =
            pFAQ[i].style.display === "none" ? "block" : "none";
